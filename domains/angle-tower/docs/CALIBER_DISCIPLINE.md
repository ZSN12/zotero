...
**y_member 侧视补读的结构边界（2026-09-03 实测归因）**：JC1 图册仅
02 册（塔头 z≥30000）有侧立面。dy 主导横梁 325 根中 255 根全册无侧视
证据；塔头 70 根中侧立面单线图只画面杆轨（~23 根，已全捕获——图面
29 个 y 层位 vs 侧读 23 横杆）。dual-view-pure 对 y_member 的补读上限
即此 ~23 根，不是引擎缺口。
