...
当前基线（2026-09-08，P1 ZC1 收口后）：JC1 dual-view-pure TP 304 / P 63.5% / R 28.4%；
ZC1 dual-union（reconstructed）R 95.1%（TP 271 @500mm，不可回退线）。
35A2-JC1（P3 全塔接入）dual-recon R 78.5%（TP 311）。GT 来源等级：`.mod/.NODE` 直出可
