...
def gt_diagonal_terminal_levels() -> list:
    ...
    """
    return [
        6500.0, 8500.0, 11500.0, 11800.0, 12000.0, 13000.0, 14000.0,
        14400.0, 14500.0, 15000.0, 16000.0, 17000.0, 18000.0, 19000.0,
        19400.0, 20700.0, 21000.0, 21500.0, 21900.0, 22000.0, 22800.0,
        24000.0, 26100.0, 27800.0, 29100.0,
        # 塔尖段（P3.5a）
